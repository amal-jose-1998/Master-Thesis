...
\par However, fully autonomous traffic systems do not yet exist anywhere in the world. \acp{AV} will have to operate in mixed traffic alongside  
...
The aim is to develop a model that can estimate likely future maneuvers while also representing uncertainty in a clear and interpretable way.
In this thesis, future maneuvers are represented internally as discrete action states.

\par To achieve this, the thesis models the temporal relationship between observable driving features and hidden behavioral states using a \ac{DBN}. 
...
The highD dataset, a realistic highway driving dataset with comprehensive vehicle trajectory recordings, is used to train and assess the model \cite{krajewski2018highddatasetdronedataset}. From these trajectories, 
