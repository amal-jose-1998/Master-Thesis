%%nd % STUDENT ACTION NECESSARY HERE %%%
...
% This class does the IAS styling for you (together with scrbook).
...
% - Provide command for title page (\makeIAStitle) and declaration of originality ( \declarationOfOriginality)
% - Loads packages "biblatex" and "graphics"
\usepackage[
    type=master, % master, bachelor, study, bachelorproject, diss
]{iasthesis}
%%% STUDENT ACTION NECESSARY HERE %%%
...
% Keep section auto-reference names capitalized even when babel switches language.
\addto\extrasenglish{%
