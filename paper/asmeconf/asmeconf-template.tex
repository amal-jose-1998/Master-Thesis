...
%%%%%  ABSTRACT  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
At least for the foreseeable future, Autonomous vehicles(AVs) will have to operate in mixed traffic with human-driven vehicles (HDVs), which requires reliable prediction of human maneuvers. 
...
This structure reflects the assumption that broader driving regime changes more slowly, whereas short-term maneuver depends on both recent behavior and current traffic context. 
...
Model parameters are estimated from the training data using expectation-maximization (EM) algorithm. 
